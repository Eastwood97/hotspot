  ...
  <div class="app-container">
    ...
    >
      ...
      <el-table-column
        align="center"
        label="Top1"
        prop="relatedResult.topOne.imsi,relatedResult.topOne.count"
      >
        <template slot-scope="scope">
          <p v-if="scope.row.relatedResult.topOne">{{ scope.row.relatedResult.topOne.imsiRatio.imsi }}</p>
          <p v-if="scope.row.relatedResult.topOne">{{ scope.row.relatedResult.topOne.imsiRatio.rationTwo }}</p>
        </template>
      </el-table-column>
      <el-table-column
        align="center"
        label="Top2"
        prop="relatedResult.topTwo.imsi,relatedResult.toptwo.count"
      >
        <template slot-scope="scope">
      ...
      <el-table-column
        align="center"
        label="Top3"
        prop="relatedResult.topThree.imsi,relatedResult.topThree.count"
      >
        <template slot-scope="scope">
